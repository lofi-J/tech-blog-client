...
thumbnail: "/mdx-images/javascript/functional-programming.png"
...
// 부분 적용
const createUserWithName = curriedCreateUser("John Doe");
const createUserWithNameAndEmail = createUserWithName("john@example.com");

const user1 = createUserWithNameAndEmail(25);
const user2 = createUserWithNameAndEmail(30);
...
const processNumbers = pipe(filter(isEven), map(double), map(addOne));

const numbers = [1, 2, 3, 4, 5, 6];
console.log(processNumbers(numbers)); // [5, 9, 13]
```
